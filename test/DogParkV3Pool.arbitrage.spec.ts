...
import { DogParkV3PoolSwapTest } from '../typechain/DogParkV3PoolSwapTest'
...
describe('DogParkV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('DogParkV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as DogParkV3PoolSwapTest
          ...
          let tester: DogParkV3PoolSwapTest
